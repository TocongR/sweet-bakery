        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Edit a product to your bakery inventory</p>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="status" 
                                ...
                                <option value="Not Available" {{ old('status', $product->status) == 'Not Available' ? 'selected' : '' }}>Not Available</option>
                                <option value="Made to Order" {{ old('status', $product->status) == 'Made to Order' ? 'selected' : '' }}>Made to order</option>
                            </select>
                            @error('status')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if (isset($product) && $product->image)
                document.getElementById('preview-img').src = "{{ asset('storage/' . $product->image) }}";    
                document.getElementById('image-preview').classList.remove('hidden');
                document.getElementById('upload-placeholder').classList.add('hidden');
            @endif
